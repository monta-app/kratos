...
func TestDefaultRegistry_AllStrategies(t *testing.T) {
	...
	t.Run("case=all login strategies", func(t *testing.T) {
		expects := []string{"password", "oidc", "saml", "code", "totp", "passkey", "webauthn", "lookup_secret", "identifier_first"}
	...
	t.Run("case=all registration strategies", func(t *testing.T) {
		expects := []string{"password", "oidc", "saml", "profile", "code", "passkey", "webauthn"}
	...
	t.Run("case=all settings strategies", func(t *testing.T) {
		expects := []string{"password", "oidc", "saml", "profile", "totp", "passkey", "webauthn", "lookup_secret"}
